...
import static org.rmj.auto.app.sales.InquiryBankApplicationFormController.incModel;
...
public class InquiryFollowUpFormController implements Initializable {
     ...
     public static InquiryTableFollowUp incModel;
     @FXML
     ...
     public static void setData(InquiryTableFollowUp inqffpdata){
        incModel = inqffpdata;    
     }
